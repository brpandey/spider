...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   dotspacemacs-default-font '("Fantasque Sans Mono" ;; "Comic Mono"
                               :size 16
                               :weight normal
                               :width normal
                               :powerline-scale 1.1)
